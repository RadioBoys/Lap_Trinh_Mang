...
public class ChatFrame extends JFrame {
	...
	public ChatFrame(String username, DataInputStream dis, DataOutputStream dos) {
		...
		btnSend.setIcon(new ImageIcon("jar\\data\\icon\\component\\send.png"));
...
//						newFile(username, fileChooser.getSelectedFile().getName(), selectedFile, true);
		...
		btnFile.setIcon(new ImageIcon("jar\\data\\icon\\component\\attach.png"));
		...
		JLabel headerContent = new JLabel("CHAT TO FRIEND");
